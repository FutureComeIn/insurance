...
<!-- Bootstrap -->
  ...
  <body style="background: #F7F7F7;">
        ...
        <!-- page content -->
        	<div id="top">
        		...
        		<div id="menu1" class="col-md-7">
                                         报案编号：<input type="text" id="peospectID"/>
            </div>
            <div class="col-md-4" id="add_employees">
        					<button type="button" class="btn btn-primary btn-small" id="reset_but" onclick="init2();">
										 重置条件
									</button>
									<button type="button" class="btn btn-primary btn-small" id="select_but" onclick="init1();">
											查询
									</button>
						</div>
					</div>
           ...
           <div class="table" id="count">
						<table class="table table-bordered" align="center" style="width: 100%" id="prospect_table">
							...
							<tr>
								...
								<th>核赔中</th>
								<th><a href="heuan_info.jsp" id="chakan">查看</a></th>
							</tr>
					</table>
    ...
    <script src="../../js/prospect/prospect.js"></script>
    <script src="../../js/jquery-1.8.3.js"></script>
	<script src="../../js/compensate/nuclear.js"></script>
  </body>
</html>
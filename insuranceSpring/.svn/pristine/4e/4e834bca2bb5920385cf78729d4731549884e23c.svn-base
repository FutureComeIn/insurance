...
<!-- Bootstrap -->
  ...
  <body style="background: #F7F7F7;">
         ...
         <div align="center">
      			...
      			<div class="table">
				   <table style="text-align: center;"  border="1" id="table"  style="border-collapse:collapse;width: 700px;" class="table table-bordered" valign="middle">
					    <tr>
					      <td>部门</td>
					      <td >人数</td>
					      <td>操作</td>
    ...
    <script src="../../../build/js/custom.min.js"></script>
     ...
     <script src="../../../src/js/employee/section.js"></script>
  </body>
</html>
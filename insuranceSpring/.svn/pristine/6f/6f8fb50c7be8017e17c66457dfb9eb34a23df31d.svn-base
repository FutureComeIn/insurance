...
//省份城市二级联动
  ...
  function allCity(){
		  ...
		  var hcity=$("#shi").val();
	  	  //alert(hprovince+" "+hcity);
	  	  //alert($("#addressShen")+" "+$("#addressShi"));
	  	  $("#bb").text(hprovince);
 ...
 function update(){
  ...
  <body style="background: #F7F7F7;" onload="allCity();">
       <form method="post" action="updateRecognizee.do?recognizeeId=${rdata.recognizeeId }" name="uform">
        	<div id="add_pros">
        		修改被保人信息
        	</div>
        	...
        	<table id="pro_bg" class="table table-bordered" align="center">
        		...
        		<tr>
        			<td>被保人姓名：<br><input type="text" class="form-control" id="recognizeeName" name="recognizeeName" value="${rdata.recognizeeName }"/></td>
        			<td>身份证：<br><input type="text" class="form-control" id="cardId" name="cardId" value="${rdata.cardId }"/></td>
        		...
        		<tr>
        			<td>联系地址/省：<br><select class="form-control" id="addressShen" name="addressShen" onchange="changeCity()">
        								<option id="bb" ></option>						
        							</select>
        			</td>
        			<td>联系地址/市：<br><select id="addressShi" name="addressShi" class="form-control" >
        								<option id="aa" ></option>						
        							 </select>
        			</td>
        			<td>联系方式：<br><input type="text" class="form-control" id="tel" name="tel" value="${rdata.tel }"/></td>
        		</tr>
				
				<tr>
        			<td>邮箱：<br><input type="text" class="form-control" id="email" name="email" value="${rdata.email }"/></td>
        			<td>银行账号：<br><input type="text" class="form-control" id="bankNumber" name="bankNumber" value="${rdata.bankNumber }"/></td>
        			<td>驾驶证号码：<br><input type="text" class="form-control" id="driveId" name="driveId" value="${rdata.driveId }"/></td>
        		</tr>
                <tr>
				    <td>行驶证编号：<br><input type="text" class="form-control" id="vehicleLicenseId" name="vehicleLicenseId" value="${rdata.vehicleLicenseId }"></td>
				    <td>发动机编号：<br><input type="text" class="form-control" id="engineId" name="engineId" value="${rdata.engineId }"/></td>
				</tr>

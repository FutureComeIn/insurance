...
public interface AssessmentDao {
	 ...
	 * @return
	 */
	@UpdateProvider(type=CarLossSqlUtils.class,method="updateAssessmentPrice")
	...
	@Update("update t_assessment set status=#{status} where assessmentId=#{assessmentId}")
	public Integer updateAssessmentStatus(Assessment at);
	
	@Delete("delete from t_assessment where assessmentId=#{assessmentId}")
	public Integer deleteAssessment(Assessment at);
}

...
<html>
	...
	<body style="background: #F7F7F7;" onload="querySettleClaimById()">
	<input type="hidden" value="${sessionScope.loginUser.userId }" id="userId"/> 
		<div id="top" >
			<form class="form-inline" role="form">
				...
				<div class="form-group">
					<input type="text" class="form-control img-rounded" id="credentials_number" placeholder="请输入理赔编号">
				</div>

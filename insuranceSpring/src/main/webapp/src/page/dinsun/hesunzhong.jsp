...
<div id="myCarousel" class="carousel slide" style="margin: 0 auto;">
	...
	<a href="" id="updateNuclearDamage" class="btn  btn-primary" data-toggle="modal" data-target="#myModal" >通过核损</a>
	<a href="" id="deleteNuclearDamage" class="btn  btn-primary" onclick="deleteNuclearDamage(${NuclearDamageInfo.nuclearDamageId},${AssessmentInfo.caseId} ,${AssessmentInfo.assessmentId})">驳回</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">提交至理赔员</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateNuclearDamage(${NuclearDamageInfo.nuclearDamageId},${AssessmentInfo.totalPrice},${AssessmentInfo.caseId} )">提交</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal --> 
</div>	

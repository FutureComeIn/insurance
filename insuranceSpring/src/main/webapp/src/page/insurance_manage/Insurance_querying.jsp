			...
			<div class="modal fade myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <form>
				      <input name="warrantyId" type="hidden" id="warrantyId"/>
				      <input name="insuranceEndTime1" type="hidden" id="insuranceEndTime1"/>
					       <div class="modal-body">
					       	  <div class="input-group">
						       	<input type="date" class="form-control" id="insuranceEndTime" name="insuranceEndTime" value="${api.singerData.insuranceEndTime}" style="width: 300px;height: 30px;">
								</div>
				             </div>

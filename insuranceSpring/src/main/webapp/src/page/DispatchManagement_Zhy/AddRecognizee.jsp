...
<!-- Bootstrap -->
  ...
  <body style="background: #F7F7F7;">
        	...
        	<table id="pro_bg" class="table table-bordered" align="center">
        		...
        		<tr>
        			<td>被保人姓名：<br><input type="text" class="form-control" id="recognizeeName" name="recognizeeName"/></td>
        			<td>身份证：<br><input type="text" class="form-control"  id="cardId" name="cardId"/></td>
				...
				<tr>
					<td>
					邮箱：<br><input type="text" class="form-control" id="email" name="email"/>
					</td>
					<td>
					银行账号：<br><input type="text" class="form-control" id="bankNumber" name="bankNumber"/>
					</td>
					<td>
					驾驶证号码：<br><input type="text" class="form-control" id="driveId" name="driveId"/>
					</td>
				</tr>
				<tr>
				    <td>
				          行驶证编号：<br><input type="text" class="form-control" id="vehicleLicenseId" name="vehicleLicenseId"/>
				    </td>
				    <td>
				          发动机编号：<br><input type="text" class="form-control" id="engineId" name="engineId"/>
				    </td>
				</tr>
	    ...
	    <script type="text/javascript" src="../../js/WarrantyInfo/address.js"></script>
   		<script type="text/javascript" src="../../js/WarrantyInfo/addRecognizee.js"></script>
